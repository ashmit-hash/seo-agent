...
- Any sentence over 15 words / Any paragraph over 3 lines
...
- Total length: 1,200 to 1,800 words — write every section fully, do not cut short
- ## for H2, ### for H3 only
...
No preamble. No commentary. Write the complete blog now.
`.trim();
...
### PARAGRAPH RULES:
- Combine short, choppy lines into smooth natural paragraphs
- Each paragraph must have a MINIMUM of 4 sentences and ideally 5 sentences
- Never write a paragraph with fewer than 4 sentences — if it is short, expand it with a relevant detail, example, or explanation
- Related ideas belong in the same paragraph — do not separate them with line breaks
- No paragraph with fewer than 4 sentences anywhere in the blog — including the opening. If the hook is a single line, add 3-4 more sentences to complete the opening paragraph.
- No bullet-point style writing — all content must flow as connected sentences
- No poetry style — no one sentence per line
