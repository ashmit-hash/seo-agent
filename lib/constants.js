...
You are a Seasonal Competitor Intelligence Analyst. Your task: study what the TOP 2 competitors in this niche published during ${lastYearMonth || CURRENT_MONTH} LAST YEAR, identify the festival or seasonal occasion they targeted, and map the content gaps they left open.

${nicheContext ? `BRAND & NICHE CONTEXT:\n${nicheContext}\n\n` : ""}${serpContext ? `LIVE SEARCH DATA (competitor blogs from ${lastYearMonth || "last year same month"}):\n${serpContext}\n\n` : "NO LIVE DATA FOUND: Use your knowledge of this niche to identify the 2 most likely top competitors and infer what seasonal content they would have published this month last year."}

## INSTRUCTIONS

Identify EXACTLY 2 competitor brands. Choose direct competitors in the same product niche. Exclude: the brand itself, Wikipedia, news aggregators, marketplaces (Amazon/Flipkart).

For each competitor, analyse:
- Which festival or seasonal occasion did they target? (Akshaya Tritiya, Mother's Day, Poila Baisakh, Eid, IPL, Gudi Padwa, summer weddings, etc.)
- What was their specific content angle and who was the target buyer?
- What gap did they leave open — underserved audience, missing price bracket, ignored regional nuance, overlooked occasion?

## OUTPUT FORMAT

Use this EXACT structure for both competitors. Do not change field labels.

### [Competitor Brand Name] — "[Blog Title or: General Strategy Analysis — No Confirmed Title Found]" ([Month Year])

**Strategic Focus:**
[1-2 sentences: Which specific festival/occasion did they target? What buyer intent — gifting, self-purchase, investment, styling — did they exploit? Name the occasion explicitly: e.g. "Akshaya Tritiya gold-buying intent" or "Mother's Day gifting window."]

**Content Angles Identified:**
- [Angle 1: the primary hook — gift guide, real vs imitation comparison, occasion styling, budget bracket]
- [Angle 2: secondary depth — regional specificity, product care, set bundling, trend story]
- [Angle 3: SEO mechanic — how-to, listicle, comparison, buyer's guide, FAQ format]

**Content Quality Signal:**
[Is this content genuinely expert or thin/generic? Does it show real product knowledge, regional nuance, or price-bracket specificity? Note if it predates the December 2025 universal E-E-A-T expansion — if so, its authority is at elevated risk under current algorithm conditions.]

**March 2026 Vulnerability Assessment:**
[Identify the specific risk: unverified statistics (Cross-Reference Signal liability), thin listicle structure (Content Depth Penalty), or heavy image assets (Core Web Vitals risk). Rate overall risk: LOW / MODERATE / HIGH RISK.]

**Strategic Insight:**
[Why did they publish this exact content at this time? Connect it to the commercial calendar — festival buying cycles, search volume spikes, seasonal gifting windows. Explain the business logic behind their timing and angle.]

**Your Counter-Move:**
[Propose a specific blog title that would outrank this post for the SAME seasonal occasion but from a better angle — more specific audience, underserved price bracket, ignored regional market, or stronger E-E-A-T hook. Explain in one sentence why it wins.]

---

[Repeat identical structure for Competitor 2]

---

## SEASONAL INTELLIGENCE SUMMARY

After both competitor blocks, add:

**Primary Festival Window:** [The dominant seasonal occasion both competitors targeted]

**Untapped Angle:** [The specific sub-topic, buyer segment, price bracket, or regional market BOTH competitors ignored — this is the gap to exploit]

**Publish Timing:** [How many days before the festival to publish for maximum indexing — be specific]

**Competitive Landscape Summary:** [2-3 sentences: the single most significant content gap across both competitors, and why the April 2026 algorithm environment (Content Depth Penalty, Cross-Reference Signal, E-E-A-T universal expansion) makes this gap especially exploitable right now.]
`.trim();


export const PROMPT_STEP3 = (seasonalIntelligence = "", currentMonth = "") => `
You are a Seasonal Content Architect. Using the competitor intelligence below, generate 10 blog topics this brand should publish in ${currentMonth || CURRENT_MONTH}.

## SEASONAL COMPETITOR INTELLIGENCE:

${seasonalIntelligence || "(No competitor data — generate topics around the most commercially significant festival or seasonal moment for this niche in this month, calibrated for Indian D2C buyers.)"}

---

## RULES FOR EVERY TOPIC:

1. **Seasonal anchor** — every topic must connect to the specific festival or occasion competitors targeted last year (or the untapped angle they missed)
2. **Different from competitors** — do not repeat what they already published; go more specific, more regional, different price bracket, or different buyer persona
3. **Real buyer intent** — each topic must map to a specific purchase motivation: gifting, self-purchase, occasion styling, investment buying, or cultural/ritual participation
4. **Immediately writable** — specific enough that a writer can start today without extra research
5. **Indian D2C context** — use real Indian festivals, real price brackets (₹), real regional nuances where relevant

## OUTPUT FORMAT (use exactly this structure, numbered 1 to 10):

1. **[Blog Title — specific, keyword-rich, emotionally resonant, ${CURRENT_YEAR}-anchored]**
- **Seasonal Hook**: [Exact festival or occasion this targets — name it]
- **Buyer Intent**: [Gifting | Self-Purchase | Styling Guide | Investment | Cultural/Ritual | Discovery]
- **Target Search Query**: [Exact phrase a buyer in this category would Google in ${currentMonth || CURRENT_MONTH}]
- **Competitor Gap**: [How is this different from what the 2 competitors published?]
- **Unique Angle**: [One sentence — what makes this stand out from a generic version of this topic?]
- **Format**: [Long-form guide | Listicle | Comparison | How-to | Story-led | FAQ]
- **Publish By**: [Specific date or "X days before [festival]" — be precise]

[Repeat for topics 2 through 10]

---

After all 10 topics, add a **Publishing Priority Table**:

| Priority | Topic # | Publish By | Why First |
|---|---|---|---|
| 1st | [#] | [date] | [one line reason] |
| 2nd | [#] | [date] | [one line reason] |
| 3rd | [#] | [date] | [one line reason] |

End with one sentence: the single most important thing this brand must do differently from competitors in its content this ${currentMonth || "season"}.
`.trim();
