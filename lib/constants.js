...
Write a complete blog post on this topic: "${choice}"
${outlineNote ? `\nApproved blueprint direction: ${outlineNote}\n` : ""}
${ragContext ? `\nVERIFIED FACTS TO USE (include these naturally — label every stat with a source):\n${ragContext}\n` : ""}
...
- Slightly skeptical (they've seen too many fancy blogs that don't help)
- Budget-conscious
- Not an expert — they just want clear, honest advice
- Reading this on their phone, probably between tasks

Your job: Make them feel "Finally, someone explained this properly."

---

## VOICE — READ THIS BEFORE YOU WRITE A SINGLE WORD

Write like a smart, helpful shop owner talking to a customer.
NOT like a journalist. NOT like a textbook. NOT like an AI trying to impress.

✅ Sounds like: "Here's the thing most people don't ask about…"
✅ Sounds like: "This is where a lot of buyers make a mistake…"
✅ Sounds like: "Honestly, the difference is simpler than it sounds…"
❌ Never sounds like: "In the contemporary landscape of Indian consumer behaviour…"
❌ Never sounds like: "The metallurgical properties of electro-deposited alloys…"
❌ Never sounds like: "In today's fast-paced world…"

If a word feels like it belongs in a research paper → delete it or rewrite it in plain English.

---

## BANNED WORDS AND PHRASES (if any of these appear, rewrite that sentence)

- "In today's world" / "In the digital age" / "In conclusion"
- "Metallurgy" / "Electro-deposition" / "Aesthetic shift" / "Economic tension"
- "Paradox" / "Nuanced" / "Leverage" / "Paradigm"
- "It is important to note" / "With that said" / "As an AI"
...
### Opening (100–130 words)

Start with ONE of these (pick whichever fits the topic):
- A relatable moment: "You're looking at two pieces. Same look, very different prices. Which one do you pick?"
- A common mistake: "Most first-time buyers make this mistake — and it costs them more later."
- A surprising truth: "The most popular jewellery right now isn't what you'd expect."

Do NOT start with the topic name. Do NOT start with a definition.
End the opening with a clear promise: "In this guide, we'll help you figure that out — simply."

---

### Body — 4 to 5 H2 sections

Each H2 section must follow this rhythm:

**[Simple, plain-English heading — like you'd say it out loud]**

One line intro: "Here's why this matters for you…" or "This is the part most blogs skip…"

Then: 3–4 short bullet points OR 2–3 short paragraphs (max 3 lines each)

If anything technical comes up — always do this:
- Simple explanation first (one line)
- Real-life example second
- What it means for the buyer third

Example:
❌ "1.5-micron electro-deposition gold plating"
✅ "Thicker gold coating — this means it stays shiny longer and doesn't turn your skin green"

Add ONE of these human touch lines per section:
...
### The One Thing They Won't Tell You (1 H2 section — 150 to 200 words)

Pick one topic from the blog and go deeper — but keep it simple.
Write it as a conversation, not an explanation.

Format:
**What most people think:** [common assumption — one line]
**What actually happens:** [simple truth — one or two lines]
**What this means when you're buying:** [practical implication — one line]

This section earns trust. It's the section people screenshot and share.
...
**Q: [Full question written the way someone types it into Google]**
A: [Answer in 2–3 simple sentences. No jargon. One example if it helps. Self-contained — don't say "as mentioned above."]

---

### Closing (80–100 words)

Give the reader ONE thing to walk away with — not a recap of everything.
Write it like a friend wrapping up a conversation:
"So here's the short version: [one-line summary]."
End with a soft CTA that doesn't feel like an ad:
"If you're still not sure, start with [specific suggestion] — it's the safest pick for most buyers."

---

## TECHNICAL REQUIREMENTS

- Total length: 1,400 to 1,800 words (readable in 5–6 minutes on mobile)
- Sentences: max 14 words each
- Paragraphs: max 3 lines each
- Every stat needs a source label: (per Google Trends India, 2026) / (per BIS data) etc.
- Use ## for H2, ### for H3 — no deeper
- Bold the most important line in each section (the one thing to remember)
- One natural CTA at the 60% mark — not a banner, just a sentence
- FAQ block before the closing

Write the full post now. Start directly with the opening sentence.
No preamble. No "here is your blog post." Just the content.
`.trim();
