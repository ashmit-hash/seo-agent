...
Never state a specific grade, specification, age range, dimension, or certification unless that EXACT phrase appears in the website context or product data provided above.
...
[ ] RULE 9 compliance: no material grade (full-grain, top-grain, genuine, 925, sterling) claimed unless that exact phrase is in the product data
[ ] RULE 9 compliance: no age range (4-7, 5-9, 8-12) stated unless published by the brand
[ ] RULE 9 compliance: no dimensions, counts, or certifications invented
...
If prices are missing for products → omit the price for that product rather than inventing one. Write "(price available on site)" as a placeholder only if no price exists.
