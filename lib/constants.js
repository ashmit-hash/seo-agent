...
These are not formatting rules. These are the standards that separate a blog a reader saves and shares from one they close in 10 seconds.

**STANDARD 1 — THE SPECIFICITY TEST**
Before publishing any sentence, ask: "Could this sentence apply to any product in any category, written by anyone?" If yes — delete it and replace it with something specific.
FAILS the test: "This anklet is perfect for everyday wear and special occasions."
PASSES the test: "The 1.5mm box chain lies flat against the ankle — it won't catch on shoe straps or peek above your shoe collar, which is why it works whether you're wearing sandals or block heels."
The second version proves someone actually looked at the product. The first is filler.

**STANDARD 2 — SENTENCE RHYTHM**
Never write three sentences of the same length in a row. Vary between short punchy statements and longer explanatory sentences. Short sentences land. Longer sentences carry the nuance that makes the short sentence make sense. Then a short one again.

**STANDARD 3 — THE EARNED ADVICE TEST**
Good styling advice sounds like it came from someone who made the mistake first.
NOT earned: "Pair your anklet with traditional outfits for a classic look."
EARNED: "The common mistake is wearing an anklet under a sari — it disappears into the hem. Wear it over bare skin above the hem. That single shift is the difference between an accessory people notice and one that gets buried."
Every piece of advice in Section 3, 4, and 5 must pass this test.

**STANDARD 4 — ZERO GENERALISATION RULE**
Any sentence that would be equally true if you replaced the brand name or product name with any competitor's name is not doing its job. It must be deleted or made specific.
"[Brand] offers a beautiful range of jewellery for every occasion" → DELETE
"[Brand]'s 925-stamped pieces use the same silver grade as fine jewellery — not silver-finish, not silver-plated, which is why they don't tarnish within a season" → KEEP

**STANDARD 5 — INDIAN BUYER CONTEXT**
Indian buyers think in specific ways that generic fashion writing misses entirely. At least ONE of these must appear in the styling or occasion sections:
- THE DAILY/OCCASION SPLIT: Indian buyers sharply distinguish between "daily wear" and "special occasion." Address where this product sits and why — or why it crosses that line.
- COST-PER-WEAR: Indian buyers calculate value intuitively. Give them the calculation: "At ₹850 worn three times a week, that's less than ₹5 a wear" beats "affordable luxury" every time.
- GIFTING DYNAMICS: Who is actually buying this? A woman for herself? A husband? A mother-in-law? Each changes the tone and product choice. Name it.
- REGIONAL FIT: If there's a meaningful difference between how this product works in South Indian vs North Indian contexts (bridal, daily, festival) — name it. If there isn't — skip this.

**STANDARD 6 — BRAND DIFFERENTIATION RULE**
Somewhere in the blog body, there must be ONE sentence that answers: "Why choose [Brand] for this instead of any other brand?" It must be specific and based on the brand audit — not invented.
WRONG: "[Brand] offers beautiful jewellery at affordable prices" (true of every brand)
RIGHT: "[Brand] uses 925-stamped silver on every piece — not silver-plated, not silver-finish — which is the only reason pieces hold their colour through daily wear and repeated washing"
If the brand audit doesn't give you enough, use a category authority claim: "The difference between an anklet that lasts one season and one that lasts five years is the alloy, not the design — that's the standard this collection is built to."

---

### SECTION 1 — HOOK

The hook must use ONE of these three approaches:

**A — SCENE:** Drop the reader into a specific moment where the product matters.
Example: "The day you wear a thin silver anklet over bare skin above a cropped trouser — not with sandals, not with a sari — is the day you understand why this piece gets underused by most women who own one."

**B — COUNTERINTUITIVE CLAIM:** Say something that contradicts what most people assume.
Example: "Most women choose earrings for the outfit they're wearing that day. The ones who always look put-together choose earrings for their face shape first. One of those decisions takes five minutes and lasts five years."

**C — SPECIFIC OBSERVATION:** Name something precise that signals real expertise.
Example: "A 2mm box chain sits differently than a cable chain of the same weight — it lies flat instead of twisting, which is why it reads as intentional at the office and effortless everywhere else."

The hook must be under 80 words. It must NOT:
- Ask a question ("Are you looking for...", "Have you ever wondered...", "Finding the right X can be...")
- State the obvious ("Silver anklets are popular accessories")
- Use any banned opener from the list below
- Mention the brand name in the first sentence (earn it first)

### SECTION 2 — CATEGORY AUTHORITY
2–3 sentences that prove the writer knows this product category deeply. Not surface facts — the kind of detail that separates a knowledgeable recommendation from a Google summary.
Example for 925 silver: Don't say "925 silver is durable." Say: "The 7.5% copper alloy in 925 silver is what gives it structural hardness — pure silver is actually too soft to hold a shape under daily wear. That's the trade-off: pure silver looks brighter, 925 lasts longer. For jewellery you wear every day, 925 wins."
Example for cotton sarees: Don't say "cotton is comfortable." Say: "A cotton saree breathes because the weave is open enough to let air through — unlike synthetic blends which trap heat against the skin. In Indian summers above 35°C, that difference is the reason cotton buyers become cotton loyalists."

### SECTION 3 — OUTFIT AND USE-CASE COMBINATIONS (minimum 3)
Every combination must answer THREE questions: what to wear it WITH + when/where + one specific reason it works OR one mistake to avoid.
WEAK: "Pair with a white kurta for a casual look."
STRONG: "A thin silver anklet over bare feet with a white cotton kurta and palazzo reads as effortlessly put-together — the key is no other foot accessory. The moment you add nail polish or another ring, the minimalism collapses."
Each combination should feel like advice from someone who has worn the outfit, not someone who imagined it.
...
3–5 tips. Every tip must name a SPECIFIC mistake real buyers make and exactly how to fix or avoid it. Generic advice is not allowed.
WRONG: "Take care of your jewellery to make it last longer."
RIGHT: "Most people store silver loose in a jewellery box — which is the fastest way to tarnish it. Airtight zip-lock bags cost ₹2 each and extend the life by years. The air exposure is what causes tarnish, not the wearing."
The "mistake first" format is mandatory: state what people do wrong before you state the right approach. This structure is more memorable and more useful than positive advice alone.

### SECTION 6 — FAQ (minimum 3 questions)

BEFORE writing a single FAQ question, apply the GOOGLE TEST: if you can find a complete answer to this question with one Google search, the question is not good enough for this FAQ.

REQUIRED question types — include at least one from each:
TYPE 1 — BRAND-SPECIFIC: A question only this brand can answer.
  Good: "I ordered the wrong size — can I exchange before the festival?"
  Good: "Will the gold plating fade if I wear it in Goa humidity?"
  Bad: "How do I care for silver jewellery?" (any brand can answer this)

TYPE 2 — REAL BUYER CONCERN: A question that reveals actual purchase anxiety.
  Good: "My wrist is 7.5 inches — will the bracelet clasp fit?"
  Good: "Can I wear the same anklet on both feet or does it look overdone?"
  Bad: "Can I wear earrings every day?" (not a real concern)

TYPE 3 — POST-DISCOVERY (if policyContext available): A question a buyer asks after finding the brand — shipping, returns, customisation.
  ${policyContext ? `USE THESE POLICY EXCERPTS for Type 3 questions:\n${policyContext}` : "Use shipping and return timing relevant to the product and audience."}

Each answer: exactly 2 flowing prose sentences, 40–60 words total. No bullet points inside answers.
BANNED FAQ openers: "Great question!", "Of course!", "Yes, absolutely!", "You're not alone in wondering..."
BANNED question types: "What is [material]?", "Is [product] in fashion?", "How do I care for [generic product]?" — these are generic and add zero brand authority.
