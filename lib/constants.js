...
You are writing a blog post for a small Indian jewellery brand's website.

Topic: "${choice}"
${outlineNote ? `Direction: ${outlineNote}\n` : ""}
${ragContext ? `Facts to use (label every stat with source):\n${ragContext}\n` : ""}

---

## WHO IS READING THIS

A regular Indian buyer — probably a housewife, a college student, or a working professional.
They are NOT an expert. They do NOT understand finance or jewellery jargon.
They are reading this on their phone while commuting or relaxing.

Write for THEM — not for Google, not for investors, not for experts.

---

## CONTENT TYPE AND STRUCTURE — FOLLOW EXACTLY

Approved Content Type: ${contentType || "Educational Content"}

Approved Structure:
${blueprintStructure || "Hook → Explain simply → Why it matters → Options → Tips → Common mistakes → FAQ → CTA"}

Follow this structure section by section. Do not add extra sections. Do not skip any.

---

## LANGUAGE RULES — THE MOST IMPORTANT PART

This is a blog for everyday Indian readers. Follow these rules strictly:

### Use ONLY basic English
Every word must be simple. If a Class 8 student would not understand it, rewrite it.

REPLACE these words immediately:
- "auspicious" → "special" or "lucky"
- "structural barrier" → "big problem"  
- "psychologically" → "in their mind" or "for most people"
- "pivot" → "switch" or "change"
- "liquidity" → "easy to sell"
- "appreciation" → "rise in value"
- "characterized by" → "is happening because of"
- "balking" → "refusing" or "stepping back"
- "sophisticated" → "smart"
- "strategically" → "smartly" or "carefully"
- "predominantly" → "mostly"
- "fundamentally altered" → "completely changed"
- "price fatigue" → "getting tired of high prices"
- Any word that sounds like a news article or finance report

### Keep sentences SHORT
Maximum 12 words per sentence.
One idea per sentence.
If a sentence has a comma AND a semicolon, split it into two.

### Keep paragraphs SHORT
Maximum 2-3 lines per paragraph.
Add a blank line between every paragraph.

### Use Indian examples and ₹ prices
- Use ₹ amounts that feel real: ₹2,000 / ₹5,000 / ₹10,000 — not ₹96,400 per 10g unless truly needed
- Reference real Indian festivals: Akshaya Tritiya, Diwali, Karwa Chauth, wedding season
- Use relatable comparisons: "cheaper than a mobile phone recharge" / "costs less than a dinner for two"

### NO technical or financial language
Do NOT write like a stock market analyst.
Do NOT write like an academic paper.
Do NOT use: YoY, MCX ticker, price ceiling, structural barrier, gold-to-silver ratio (unless explained in one simple line)

---

## SPELLING AND GRAMMAR

Write in correct, clean English.
Proofread every sentence before including it.
No spelling mistakes. No missing words. No broken sentences.
If you are unsure of a spelling — use a simpler word instead.
...
- Any word a Class 8 student would need to Google

---

## ADD HUMAN TOUCH LINES (at least 3)

Place these naturally — they make the blog feel real:
- "Most people don't know this…"
- "This is where many buyers go wrong…"
- "Here's the honest answer…"
- "If you remember just one thing, remember this…"
- "A lot of people ask us this…"
...
- Start with one simple sentence that states the main point
- Use 2-3 short bullet points OR 2 short paragraphs
- End with one line that connects to the next section

---

## TECHNICAL REQUIREMENTS

- Total length: 900 to 1,300 words (easy to read in 4-5 minutes)
- ## for H2, ### for H3 only
- Bold ONE important line per section
- Add FAQ with 3-4 simple questions before the closing
- End with a soft, natural CTA — not pushy

Write the full blog now. Start with the H1 title: "${choice}"
No intro. No "here is your blog." Just start writing.
`.trim();
...
3. Apply the feedback carefully — if the user asked for simpler language, simplify; if they asked for more examples, add them; if they asked to remove a section, remove it
4. If the feedback conflicts with the content type, resolve it intelligently — apply the spirit of the feedback while keeping the blog aligned with its blueprint
5. Do not add new sections that weren't in the original blueprint
6. Keep the original topic and core message intact
7. Do not repeat the same content from the original that the user is clearly unhappy with

## VOICE RULES (same as original)

- Simple English only
- Sentences: max 14 words
