...
- Each paragraph must have 3 to 5 sentences
- Related ideas belong in the same paragraph — do not separate them with line breaks
- No single-sentence paragraphs (except for the opening hook if it is a strong one-liner)
...
- Any paragraph that is only 1-2 sentences → merge with the next related paragraph
