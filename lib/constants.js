...
You are writing a blog post for a specific brand's website. The blog must read like it was written by someone who knows this brand's actual products and prices — not a generic article that could apply to any brand.
...
Read the website context below carefully. The product list below is REAL — scraped directly from this brand's store:
...
1. "This website is about: [identify the actual category from website context — bags, food, fashion, SaaS, tiffin service, etc.]"
2. "The blog topic is: ${choice}"
3. "This is NOT a jewellery blog unless the website context EXPLICITLY and CLEARLY states this brand sells jewellery."

🚨 BAGS / ACCESSORIES BRAND OVERRIDE (HIGHEST PRIORITY RULE):
If the website context mentions bags, handbags, purses, clutches, totes, wallets, sling bags, or leather goods:
- Write ENTIRELY about bags and accessories. Zero jewellery content.
- If the topic title says "jewellery" or "style guide for jewellery" — IGNORE that word and write about BAGS instead.
- Replace every jewellery example (necklace, earring, ring, bangle) with a bag example (tote, clutch, sling bag, wallet).
- The word "jewellery" must NOT appear anywhere in this blog.
...
If the website sells bags — write about bags. Never jewellery.

🚨 DO NOT default to jewellery examples, jewellery keywords, or jewellery tone unless the website context CLEARLY AND EXPLICITLY says this brand sells jewellery. "Accessories" alone does NOT mean jewellery.
...
## 🛍️ PRODUCT INTEGRATION — NON-NEGOTIABLE RULE

The WEBSITE CONTEXT above contains a section labelled **"REAL PRODUCTS FROM THIS STORE"** or **"REAL PRODUCTS ON THIS WEBSITE"**. This is the actual product catalog scraped directly from the brand's store.

🚨 YOU MUST FOLLOW ALL FIVE RULES BELOW — NO EXCEPTIONS:

**RULE 1 — Use exact product names**
Pick at least 4–6 products from the list and mention them BY THEIR EXACT NAME inside the blog. Copy the name character-for-character. Do NOT paraphrase, rename, shorten, or invent variations.

**RULE 2 — Use exact prices — this is the most important rule**
If the product list shows a price (e.g. "• Canvas Tote Bag — ₹650"), write that EXACT price in the blog when mentioning that product. Do NOT invent a different price. Do NOT round it, estimate it, or change the number even by ₹1. Wrong prices destroy brand trust and make the business look unprofessional. If a product is listed at ₹1,250 — write ₹1,250, never ₹1,200 or ₹1,299.

**RULE 3 — Weave products naturally into the content**
Products should appear inside the blog paragraphs as natural recommendations — not in a separate product table or as a standalone list. Make each mention feel like editorial advice.

**RULE 4 — No invented products — absolute ban**
Every product name you write must exist in the product list above. If a product is not in the list, do not mention it. Do NOT invent product names even if they sound realistic. Do NOT mention "Lichi Silk Jacquard Saree" if it is not in the list. Do NOT mention any product name that you have not copied directly from the list above.

**RULE 5 — Products must match the blog topic**
Only mention products that are DIRECTLY RELEVANT to the blog title and topic. If the blog is titled "Cotton Sarees" — only mention products that are cotton or cotton-blend sarees. Do NOT include linen, silk, tissue, or Banarasi products in a cotton saree blog even if they are in the product list. If the blog is about "Mirror Earrings" — only include products whose name contains "mirror" or "oxidized" — do NOT include pearl, crystal, or floral products just because they are earrings.

EXAMPLE — if the product list says:
• Canvas Tote Bag – Blue — ₹650
• Leather Wallet — ₹890
• Sling Bag – Red — ₹750

Then write something like:
"The Canvas Tote Bag in Blue (₹650) is one of the most practical everyday bags — it fits your laptop, lunch, and water bottle without looking like a carry-all. For something more compact, the Sling Bag in Red at ₹750 is a smart pick for college or a quick grocery run. And if you need something that goes from casual to meetings, the Leather Wallet at ₹890 keeps everything organised in your pocket."

🚨 PRODUCT VERIFICATION STEP — DO THIS BEFORE WRITING THE BLOG:
Before you write a single sentence, list the products you plan to mention and verify each one exists in the product list above with the correct price. If a product you planned to mention is NOT in the list — remove it from your plan and replace with one that IS in the list.

If the website context does NOT have a product list — write generic examples and clearly label them as "for example, a brand like this might offer..." rather than asserting they exist.

---

## SELF-CHECK — DO THIS BEFORE FINALISING

Before you output the blog, verify every item. If any answer is NO — fix it before outputting:

- ❌ Does this blog mention jewellery for a NON-JEWELLERY brand? → REWRITE every jewellery mention
- ❌ Does this blog mention bags for a NON-BAGS brand? → REWRITE to match actual brand category
- ❌ Does this blog mention "Alippo" anywhere in the body or CTA? → REMOVE it. Replace with the actual brand name from the website context. "Alippo" is the platform, NOT the brand.
- ❌ Is there any H2 heading that contains the words "Keyword Integration", "Modified", "SEO Section", "Step", "Section", or any other meta-instruction phrase? → DELETE that heading entirely. Rewrite the paragraph below it with the keywords woven naturally into prose.
- ✅ Does the blog mention at least 4 specific REAL products from the product list BY EXACT NAME (copied character-for-character)? → If no, ADD them now
- ✅ Does the blog include the EXACT PRICE for each product mentioned, matching the product list exactly? → If no, FIX the prices now. Compare each price you wrote against the product list.
- ✅ Does every product mentioned in this blog MATCH the blog topic? (e.g. if the blog is about cotton sarees, are all products cotton sarees?) → If no, REMOVE the irrelevant products and replace with matching ones from the list.
- ✅ Would this blog make sense if published on THIS specific website? → If no, REWRITE entirely
- ✅ Does ANY price exceed the brand's PRICE RANGE? → If yes, REPLACE with a price within range
- ✅ Are all examples specific to this brand's actual products — not generic industry examples? → If no, REPLACE
- ✅ Does every FAQ answer have at least 40 words? → If any answer is shorter, expand it now
...
- "Ever wondered how to..." / "It's a common struggle..." / "Most people don't realize this..."
- "Here's the honest answer..." / "If you remember just one thing..."
- "adding a touch of elegance" / "elevate your entire look" / "perfect for special occasions" / "exudes confidence"
...
These phrases make the blog read like a generic AI template. Write with direct authority instead. Say what you mean plainly: "Cotton sarees breathe well in summer heat" not "Most people don't realize that cotton sarees are surprisingly versatile..."
...
- FAQ with 3-4 real questions before closing. Each FAQ answer MUST be 40-60 words minimum — this is the exact length Google uses for featured snippets and People Also Ask boxes. A 10-word FAQ answer will never get picked up by search engines. Write complete, helpful answers.
- End with a complete closing paragraph and soft CTA — NEVER mention "Alippo" in the CTA. Use the actual brand name from the website context.
