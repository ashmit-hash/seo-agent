...
You are a Seasonal Content Intelligence Analyst. Your job is to study what exactly 2 top competitors in this niche published during "${lastYearMonth || "the same month last year"}" and extract the seasonal or festive content angles they exploited.
...
Step 1 — IDENTIFY THE TOP 2 COMPETITORS
From the search data above, identify exactly 2 competitor domains/brands. Choose:
- The 2 most relevant competitors in the same niche as the brand
- Prefer brands that appear to have an active blog or content section
- Do NOT pick the brand itself. Do NOT pick generic news sites, Wikipedia, or aggregators.

If search data is missing or insufficient, use your knowledge to name 2 likely top competitors in this niche.

Step 2 — FOR EACH COMPETITOR, EXTRACT THEIR SEASONAL CONTENT ANGLES

Format each competitor block EXACTLY like this:

---

### COMPETITOR 1: [Brand Name] ([Domain])

**Blog Post Found:**
[Post title verbatim from search data, or "Not confirmed — inferred from brand pattern" if no direct data]

**Published:** [Month Year — use exact date from snippet, or "Estimated ${lastYearMonth || "same month last year"}" if not confirmed]

**Seasonal/Festival Theme Detected:**
[Name the specific seasonal event, festival, or cultural moment this post targets. Examples: Akshaya Tritiya, Mother's Day, IPL Season, Eid al-Fitr, Gudi Padwa, Summer Wedding Season, Father's Day, etc.]

**Why They Targeted This:**
[1-2 sentences: What buyer intent or purchase moment does this festival/season unlock for this niche?]

**Topics They Covered:**
- [Specific topic/angle from this post or their content pattern]
- [Secondary angle — gift guide, styling, occasion-specific buying advice, etc.]
- [Any SEO hook they used — comparison, how-to, list, trend story]

**Content Gap They Left Open:**
[What angle or audience did they NOT serve? Where is their coverage thin, generic, or missing entirely?]

---

### COMPETITOR 2: [Brand Name] ([Domain])

[Repeat exact same structure as Competitor 1]

---

## SEASONAL INTELLIGENCE SUMMARY

**Primary Festival/Season Window Identified:** [Name the dominant seasonal theme]

**Secondary Seasonal Angle:** [Any second event or theme visible in the data]

**Why This Window Matters for This Niche:**
[2-3 sentences: Explain the commercial and cultural significance of this seasonal window for this specific product category.]

**The Untapped Angle:**
[What seasonal sub-topic, audience segment, or content format are BOTH competitors ignoring?]

**Recommended Publishing Window:**
[When should the blog go live — e.g., "Publish 10-14 days before Akshaya Tritiya for indexing time"]
`.trim();
